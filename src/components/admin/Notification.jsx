  ...
  return (
    <div className="con flex flex-col bg-[rgba(1,1,27)] w-[100vw] justify-center items-center ">
      {notifi.map((e, index) => (
        <div
          key={index}
          className="notifi flex flex-row justify-between h-auto items-center my-[7px] w-[90%] md:w-[80%] gap-auto bg-[linear-gradient(to bottom right,rgba(10, 10, 46, 0.9),
  rgba(1, 1, 27, 0.95))] border-1 border-[#80d6e3] rounded-2xl md:rounded-[40px] hover:scale-[1.05] hover:border-2 hover:border-[#33bbcf]  "
        >
          <div className="notifi_info my-1 ml-5 md:ml-20">
            <h2 className="text-1xl md:text-2xl font-[500] text-white ">
          ...
          <div className="image_con ">
            <img
              ...
              alt="image"
              className=" h-[45px] md:h-[60px] w-[55px] md:w-[70px] object-fill border rounded-[10%] my-5 mr-5 md:mr-20 "
            />
          </div>
        </div>
      ))}
