...
const initialStudyMaterial = {
  6: {
    English: [
      ...
      },
      {
        ...
        link: "https://ncert.nic.in/textbook/pdf/hesc2dd.zip",
      },
    ],
    Hindi: [
      {
        title: "Vasant Bhag 1",
        link: "https://ncert.nic.in/textbook/pdf/chhn1dd.zip",
      },
      {
        title: "Bal Ram Katha",
        link: "https://ncert.nic.in/textbook/pdf/chbr1dd.zip",
      },
    ],
    Math: [
      {
  ...
  7: {
    ...
    Hindi: [
      {
        title: "Vasant Bhag 2",
        link: "https://ncert.nic.in/textbook/pdf/chhn2dd.zip",
      },
      {
        title: "Durva 2",
        link: "https://ncert.nic.in/textbook/pdf/chdu2dd.zip",
      },
    ],
    Math: [
      {
        title: "Mathematics",
        link: "https://ncert.nic.in/textbook/pdf/memh2dd.zip",
      },
    ],
    Science: [
      {
  ...
  8: {
    ...
    Hindi: [
      {
        title: "Vasant Bhag 3",
        link: "https://ncert.nic.in/textbook/pdf/chhn3dd.zip",
      },
      {
        title: "Durva 3",
        link: "https://ncert.nic.in/textbook/pdf/chdu3dd.zip",
      },
    ],
    Math: [
      {
        title: "Mathematics",
        link: "https://ncert.nic.in/textbook/pdf/memh3dd.zip",
      },
    ],
    Science: [
      {
        title: "Science",
        link: "https://ncert.nic.in/textbook/pdf/hesc3dd.zip",
      },
    ],
    Notes: [],
  },
  9: {
    English: [
      ...
      {
        title: "Moments",
        link: "https://ncert.nic.in/textbook/pdf/jesc2dd.zip",
      },
    ],
    Hindi: [
      {
        title: "Kshitij",
        link: "https://ncert.nic.in/textbook/pdf/jhsk1dd.zip",
      },
      {
        title: "Kritika",
        link: "https://ncert.nic.in/textbook/pdf/jhkr1dd.zip",
      },
    ],
    Math: [
      {
    ...
    SocialScience: [
      {
        title: "India & the Contemporary World – I",
        link: "https://ncert.nic.in/textbook/pdf/jhwh1dd.zip",
      },
    ],
    Notes: [],
  },
  10: {
    ...
    Hindi: [
      {
        title: "Kshitij 2",
        link: "https://ncert.nic.in/textbook/pdf/jhsk2dd.zip",
      },
      {
        title: "Kritika 2",
        link: "https://ncert.nic.in/textbook/pdf/jhkr2dd.zip",
      },
    ],
    Math: [
      {
        title: "Mathematics",
        link: "https://ncert.nic.in/textbook/pdf/jemh2dd.zip",
      },
    ],
    Science: [
      {
    ...
    SocialScience: [
      {
        ...
        link: "https://ncert.nic.in/textbook/pdf/jhwh2dd.zip",
      },
    ],
    Notes: [],
  },
    ...
    Physics: [
      {
        ...
        link: "https://ncert.nic.in/textbook/pdf/keph1dd.zip",
      },
      {
        title: "Physics Part 2",
        link: "https://ncert.nic.in/textbook/pdf/keph2dd.zip",
      },
    ],
    Chemistry: [
      {
        title: "Chemistry Part 1",
        link: "https://ncert.nic.in/textbook/pdf/kech1dd.zip",
      },
      {
        title: "Chemistry Part 2",
        link: "https://ncert.nic.in/textbook/pdf/kech2dd.zip",
      },
    ],
    Biology: [
      {
        title: "Biology",
        link: "https://ncert.nic.in/textbook/pdf/kebo1dd.zip",
      },
    ],
    Accountancy: [
      {
        title: "Accountancy Part 1",
        link: "https://ncert.nic.in/textbook/pdf/kacc1dd.zip",
      },
      {
        title: "Accountancy Part 2",
        link: "https://ncert.nic.in/textbook/pdf/kacc2dd.zip",
      },
    ],
    Business: [
      {
        title: "Business Studies",
        link: "https://ncert.nic.in/textbook/pdf/kbst1dd.zip",
      },
    ],
    Economics: [
      {
        title: "Indian Eco. Development",
        link: "https://ncert.nic.in/textbook/pdf/keec1dd.zip",
      },
    ],
    History: [
      {
        title: "Themes in World History",
        link: "https://ncert.nic.in/textbook/pdf/kjhh1dd.zip",
      },
    ],
    Geography: [
      {
        title: "Fundamentals of Physical Geography",
        link: "https://ncert.nic.in/textbook/pdf/kegg1dd.zip",
      },
    ],
    PoliticalScience: [
      {
        title: "Indian Constitution at Work",
        link: "https://ncert.nic.in/textbook/pdf/kjps1dd.zip",
      },
    ],
    Notes: [],
  },
  12: {
    Physics: [
      ...
      {
        title: "Physics Part 2",
        link: "https://ncert.nic.in/textbook/pdf/leph2dd.zip",
      },
    ],
    Chemistry: [
      {
      ...
      {
        title: "Chemistry Part 2",
        link: "https://ncert.nic.in/textbook/pdf/lech2dd.zip",
      },
    ],
    Biology: [
      {
        title: "Biology",
        link: "https://ncert.nic.in/textbook/pdf/lebo1dd.zip",
      },
    ],
    Accountancy: [
      {
        title: "Accountancy Part 1",
        link: "https://ncert.nic.in/textbook/pdf/lacc1dd.zip",
      },
      {
        title: "Accountancy Part 2",
        link: "https://ncert.nic.in/textbook/pdf/lacc2dd.zip",
      },
    ],
    Business: [
      {
        title: "Business Studies",
        link: "https://ncert.nic.in/textbook/pdf/lbst1dd.zip",
      },
    ],
    Economics: [
      {
        title: "Introductory Macro Economics",
        link: "https://ncert.nic.in/textbook/pdf/leec1dd.zip",
      },
    ],
    History: [
      {
        title: "Themes in Indian History Part 1",
        link: "https://ncert.nic.in/textbook/pdf/ljhh1dd.zip",
      },
    ],
    Geography: [
      {
        title: "Fundamentals of Human Geography",
        link: "https://ncert.nic.in/textbook/pdf/legg1dd.zip",
      },
    ],
    PoliticalScience: [
      {
        title: "Contemporary World Politics",
        link: "https://ncert.nic.in/textbook/pdf/ljps1dd.zip",
      },
    ],
    Notes: [],
  },
...
export default function StudyResources() {
    ...
    if (noteTitle && selectedClass && selectedSubject && noteFile) {
      ...
      setStudyMaterial((prev) => {
        ...
        updated[selectedClass] = {
          ...updated[selectedClass],
          [selectedSubject]: [
            ...(updated[selectedClass][selectedSubject] || []),
            newNote,
          ],
        };
        return updated;
      ...
      setSelectedSubject("");
      alert(
        `📤 "${noteTitle}" uploaded to Class ${selectedClass} - ${selectedSubject}`
      );
    } else {
  ...
  return (
    <div className=" bg-gradient-to-br from-white via-blue-50 to-blue-100 rounded-2xl shadow-lg">
      ...
      >
        {Object.entries(studyMaterial[selectedClass]).map(
          ([subject, files]) => (
            <div
              key={subject}
              className={`p-4 rounded-xl border shadow-sm ${
                subjectColors[subject] || "bg-white"
              }`}
            >
