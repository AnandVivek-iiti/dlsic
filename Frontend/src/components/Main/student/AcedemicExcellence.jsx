      ...
      {showMore && (
        <div className="mt-6 animate-fadeIn space-y-6">
          ...
          <div className="bg-gray-100 p-6 border-l-4 border-blue-600 rounded">
            ...
            <p className="text-center font-semibold italic">Science Students</p>
            <div className="flex flex-wrap justify-center gap-6 mt-4">
              <HonorCard name="रितिका शुक्ला" desc="Class 10 - 88% class topper" img="AV.png" />
              <HonorCard name="आनंद विवेक" desc="District Rank #1 with 95.2%, IIT-JEE / NDA Qualified, Study at IIT Indore" img="AV1.png" />
            </div>
            ...
            <p className="text-center font-semibold italic">Science Students</p>
            <div className="flex flex-wrap justify-center gap-6 mt-4">
              <HonorCard name="सोवरन" desc="Class 12 - 85.2%, IIT-JEE Qualified, Study at IIIT Jabalpur" img="SR.png" />
              <HonorCard name="अनुराग पांडेय" desc="District Topper #9 with 92.2%, Indian Navy" img="AP.png" />
              <HonorCard name="आशीष शर्मा" desc="NEET Qualified" img="AS.png" />
            </div>
          </div>
        </div>
      )}
